...
if(r.status_code == 500):
    ...
    alert_r = requests.post('curl -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}' https://hooks.slack.com/services/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', json={"text": ":rage:\n500 response from BLAST CACHE\nSeq MD5: "+file_contents['md5']})
